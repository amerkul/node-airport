...
VALUES ('Passenger', 'cat', '$2a$10$VvrWAnDgocwpcR8swpWvCe1.7x1s0WatZYDZfYOXL1kB9of5qxu4u', 
	   'Cat', 'Black', 'MP5656565', 'cat@mail.ru', '2005-03-03', 'Cat Black', '+375291111111',
	   'Female', true);

INSERT INTO users(role, username, password, first_name, last_name, passport, email, birthday, 
				 full_name, phone, sex, active)
VALUES ('Manager', 'dog', '$2a$10$CzBImpmRZnIkf9cD94218.aoGNRNOmEuQFI9V58XZR1QvL7tAd2Dy', 
	   'Dog', 'White', 'MP3433434', 'dog@mail.ru', '2004-03-03', 'Dog White', '+375292222222',
	   'Male', true),
	   ('Admin', 'amerkul', '$2a$10$imhdj0Sa1IrbRHdFf.EbpO5ZDGlw.zWLXFThrm/4RIKkCnIfMouIG', 
